...
function dijkstra(graph, start, end) {
    ...
    while (!pq.isEmpty()) {
        ...
        for (let neighbor in graph[currentNode]) {
            const newDistance = distances[currentNode] + graph[currentNode][neighbor] // jarak node saat ini + jarak tetangga dari currentNode

            // update jarak kalau jarak baru lebih kecil dari jarak sebelumnya
