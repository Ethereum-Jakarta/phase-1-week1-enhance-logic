...
// Deskripsi: Kalian diberikan sebuah array bilangan bulat nums yang terurut secara menaik
// (dengan nilai-nilai yang berbeda-beda).

// Sebelum diserahkan ke dalam fungsi Kalian, array nums kemungkinan telah dirotasi pada
// indeks pivot yang tidak diketahui k (1 <= k < panjang nums) sehingga array yang dihasilkan
// adalah [nums[k], nums[k+1], ..., nums[n-1], nums[0], nums[1], ..., nums[k-1]] (0 berindeks).
